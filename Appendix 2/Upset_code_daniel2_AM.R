...
list_full <- list(diabetes_icd10=diabetes_icd10,hypertension_icd10=hypertension_icd10,
                  ...
                  low_phys_activity=low_phys_activity,proxy_dementia=proxy_dementia)
...
upset_object$Total <- rowSums(upset_object[,c(2:20)])
upset_object <- upset_object[order(upset_object$Total,decreasing = TRUE),]

write.csv(upset_object,"boruta_list_full_results_male_noE4.csv")

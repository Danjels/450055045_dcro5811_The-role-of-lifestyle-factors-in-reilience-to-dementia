...
library(Boruta)
#library(dplyr)
# This creates a .lock file (renv.lock) and saves the packages (with versions) there.
renv::snapshot()
...
dat$apoe4_copies[dat$apoe_genotype==22] <- 0
dat$apoe4_copies[dat$apoe_genotype==23] <- 0
dat$apoe4_copies[dat$apoe_genotype==24] <- 1
dat$apoe4_copies[dat$apoe_genotype==33] <- 0
dat$apoe4_copies[dat$apoe_genotype==34] <- 1
dat$apoe4_copies[dat$apoe_genotype==44] <- 2
dat$apoe4_copies <- as.factor(dat$apoe4_copies)
...
# This saves all packages that have been opened.
renv::snapshot()